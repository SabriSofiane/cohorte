                ...
                <form action="gestion_cohorte.php" method="post">
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="<?php echo $eleve->precisionSituation; ?>" class="form-control" placeholder="Préciser" name="precisionSituation" id="precisionSituation" required="required" pattern="^[a-zA-Z\-çïéèêëîàôöÏÎËÊÉÈÇÔÖùœ ]*$">
                            </div>
                        </div>
                        <br>
                        <br>
                        ...
                        if (!isset($_GET['id'])) {
                            ...
                            <input type='checkbox' class='custom-control-input' id='customCheck1' name='rgpd' required='required' >
                            <label class='custom-control-label' for='customCheck1' >J'ai bien lu les</label>
                            <a href='informations.php' >mentions légales.</a> 
                            <a>*</a>
                        </div>";
                        }
                        ?>
